...
export function createMnemonic(item, profile) {
    ...
    const anchorPool = ANCHORS[profile.cityAnchors[0]] ?? ['Trailhead', 'Bridge', 'Fountain'];
...
function buildAction(device, item, rand) {
